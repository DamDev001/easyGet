...
export default function Successful() {
  const [getReceiversName, setGetReceiversName] = useState(JSON.parse(localStorage.getItem("receiverName")))
        ...
        <div className="center">
          <div className="center-container">
            ...
            <div className="center-content">
              <span>You've Successfully Sent Money To</span>
              <p>{getReceiversName}</p>
            </div>
          </div>
        </div>
      </div>
